            ...
            <Tab eventKey='withdraw' title='Withdraw' className='bg-dark'>
                ...
                <form className='row' onSubmit={(event) => {
                    ...
                    <div className='col-12 col-sm pr-sm-2'>
                        <input
                            type='text'
                            placeholder='POW Amount'        // store amount change in redux store
...
class Balance extends Component {
    ...
    async loadBlockchainData() {
        ...
        // dispatch - react redux, web3 - ether balance, exchange - smart contract to read tokenBalance & etherBalance, token - read tokenBalance from token.sol, account - current account for balance
