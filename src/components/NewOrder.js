...
function mapStateToProps(state) {
    ...
    return {
        ...
        buyOrder,
        sellOrder,
        showForm: !buyOrder.making && !sellOrder.making,     // as long as orders are NOT being made

        // show buy total if order price and order amount exist
        showBuyTotal: buyOrder.amount && buyOrder.price,
        showSellTotal: buyOrder.amount && buyOrder.price
